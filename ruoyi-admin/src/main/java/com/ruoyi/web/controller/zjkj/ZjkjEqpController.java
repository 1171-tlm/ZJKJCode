...
import com.ruoyi.zjkj.service.IZjkjEqpService;
...
public class ZjkjEqpController extends BaseController
{
     ...
     * 查询设备信息列表
     */
    @RequiresPermissions("zjkj:eqp:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出设备信息列表
     */
    @RequiresPermissions("zjkj:eqp:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存设备信息
     */
    @RequiresPermissions("zjkj:eqp:add")
     ...
     * 修改保存设备信息
     */
    @RequiresPermissions("zjkj:eqp:edit")
     ...
     * 删除设备信息
     */
    @RequiresPermissions("zjkj:eqp:remove")
